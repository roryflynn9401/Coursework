...
public class BankClient { 
	...
	public ArrayList<Integer> accountNumbers = new ArrayList<Integer>();
	public ArrayList<String> accountTypes = new ArrayList<String>();
	public ArrayList<Boolean> accountVerified = new ArrayList<Boolean>();
	public ArrayList<Double> accountBalances = new ArrayList<Double>();
